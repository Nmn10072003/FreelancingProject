  ...
  return (
    <div className="bg-white text-white min-h-screen m-12 rounded-md">
      <div className="container mx-auto px-4 py-10">
        <h1 className="bg-white text-gray-900 text-3xl font-bold text-center">
          Download Catalogue
        </h1>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 my-10">
          {catalogues.map((catalogue, index) => (
            ...
            >
              ...
              <a
                href={catalogue.link}
                className="bg-teal-700 hover:bg-teal-900 text-white text-sm font-medium py-2 px-4 rounded"
              >
                Download Catalogue
              </a>
            </div>
